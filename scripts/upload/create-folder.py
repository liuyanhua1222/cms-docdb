...
示例: python3 -B <skill-dir>/scripts/upload/create-folder.py 0 "新产品" --project-id 10001 --confirm YES；缺参补齐后用同一 python 命令重试
""")
    parser.add_argument("parent_id", type=int, help="父目录 fileId；空间根传 0 时必须同时传 --project-id")
